...
export class thirdMigration1583005409173 implements MigrationInterface {
    name = 'thirdMigration1583005409173'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "refundableInvoiceReport" ("id" SERIAL NOT NULL, "type" character varying(255) DEFAULT 'N/A', "rnc" character varying(255) NOT NULL, "ncf" character varying(255) NOT NULL, "invoiceDate" date NOT NULL, "details" character varying(255), "businessType" character varying(255) NOT NULL, "provider" character varying(255) NOT NULL, "paymentMethod" character varying(255) NOT NULL, "subTotal" numeric(19,2) NOT NULL, "itbis" numeric(19,2) NOT NULL, "tip" numeric(19,2) NOT NULL, "total" numeric(19,2) NOT NULL, "status" character varying(255) NOT NULL DEFAULT 'Pendiente', "hasTip" character varying NOT NULL DEFAULT 'false', "hasItbis" character varying NOT NULL DEFAULT 'false', "userId" integer NOT NULL, CONSTRAINT "UQ_30755b307a172644a06e51a576f" UNIQUE ("ncf"), CONSTRAINT "PK_4b8445a0f72a71b38aaaca6da5f" PRIMARY KEY ("id"))`, undefined);
